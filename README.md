...
Thanks for deciding to help out. Please open an issue, and leave a comment so that we know what you're working on, and we don't work on the same thing. Thanks!<br>
Please read [CONTRIBUTING.md](https://github.com/CoderDJD/Hoot/blob/main/CONTRIBUTING.md) for details on this project.

# Code Of Conduct

Please read [CODE_OF_CONDUCT.md](https://github.com/CoderDJD/Hoot/blob/main/CODE_OF_CONDUCT.md) before any activity in this repository, for the details of our code of conduct.
