...
interface Props extends Project {
  ...
  small?: boolean;
  inView?: boolean; // If its currently in active state
}

const ProjectUnit = ({ onClickProject, small, inView, ...props }: Props) => {
  ...
  return (
    <div
      ref={wrapper}
      className={`px-5 py-2 my-5 border-2  border-solid border-gray-200 bg-white rounded-md shadow-sm transition-shadow hover:shadow-lg ${
        inView ? "shadow-xl" : ""
      }`}
    >
